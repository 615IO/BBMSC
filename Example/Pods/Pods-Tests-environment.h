...
// BBMSC
#define COCOAPODS_POD_AVAILABLE_BBMSC
#define COCOAPODS_VERSION_MAJOR_BBMSC 1
#define COCOAPODS_VERSION_MINOR_BBMSC 0
#define COCOAPODS_VERSION_PATCH_BBMSC 0
